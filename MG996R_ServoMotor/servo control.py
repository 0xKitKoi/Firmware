...
servoPinX = 27
servoX = machine.PWM(machine.Pin(servoPinX))
servoX.freq(50)
servoPinY = 26
servoY = machine.PWM(machine.Pin(servoPinY))
servoY.freq(50)
on = True
...
def set_servo_angle(servo, angle):
    ...
    max_duty = 7000  # this seems to be 180 degrees to me
    ...
    # Set the duty cycle
    #servo.duty_u16(int(duty * 65535 / 1023)) //doesnt work
